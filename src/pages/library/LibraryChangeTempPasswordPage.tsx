...
// Standalone route (outside LibraryLayout, no nav chrome) — mandatory on first login with a temp
// password, mirrors ShopChangeTempPasswordPage.tsx exactly, just role/route-swapped.
export default function LibraryChangeTempPasswordPage() {
  ...
  useEffect(() => {
    ...
    if (!user.mustChangePassword) { navigate('/library', { replace: true }); return; }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate('/library/verify-email', { replace: true });
    } catch (err: any) {
