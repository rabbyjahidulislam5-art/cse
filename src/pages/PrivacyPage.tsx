    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 sm:px-6 py-8 max-w-2xl">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-xl font-bold text-foreground">Campus Privacy Policy</h1>
        ...
        <div className="rounded-2xl border border-border bg-card/50 p-8 text-center space-y-4">
          ...
          <p className="text-sm text-muted-foreground max-w-md mx-auto leading-relaxed">
            The Campus Privacy Policy for Smart Campus Digital Wallet is being finalized. Please check back soon for the full document.
          </p>
        </div>
      </div>
    </div>
