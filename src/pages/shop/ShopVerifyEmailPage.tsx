...
// Standalone route (outside ShopLayout, no nav chrome) — mandatory after the temp-password change,
// mirrors OtpDialog.tsx's entry UI but as a full page since it gates the whole dashboard.
export default function ShopVerifyEmailPage() {
  ...
  useEffect(() => {
    ...
    if (user.emailVerified) { navigate('/shop', { replace: true }); return; }
